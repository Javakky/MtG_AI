import unittest
from typing import cast, Tuple, NoReturn, List
...
class ExpertTest(TestCase):
    ...
    def test_exists_exchanged_low_cost_pair(self) -> NoReturn:
        self.assertEqual(
            False,
            exists_exchanged_low_cost_pair(
                cast(Creature, CARD_POOL.get_card("3/2(2)")),
                cast(List[Creature], flatten([
    ...
    def test_exists_one_sidedly_destroied_pair(self) -> NoReturn:
        self.assertEqual(
            False,
    ...
    def test_exists_exchange_high_cost_next_turn(self) -> NoReturn:
        self.assertEqual(
            False,
    ...
    def test_find_one_sidedly_destroied_smaller_cost_pair(self) -> NoReturn:
    ...
    def test_find_exchanged_low_cost_creature(self) -> NoReturn:
    ...
    def test_maximum_playable_creature_count_enough_land(self) -> NoReturn:
        self.assertEqual(
            4,
    ...
    def test_count_smallest_pair_exceeds_my_life(self) -> NoReturn:
        self.assertEqual(
            2,
    ...
    def test_find_exchanged_creature_pair(self) -> NoReturn:
    ...
    def test_find_damage_destroyable_max_cost_assign(self) -> NoReturn:
        self.assertEqual(
            [0, 0, 1, 2, 1],
            find_damage_destroyable_max_cost_assign(
                4,
                cast(List[Tuple[int, Creature]], flatten([
